...
| `docs/USER_GUIDE.md`, `docs/platform-comparison.md`, `docs/macos.md`, `docs/sandbox-comparison.md` | AMD/ROCm sections + matrix rows; macOS = neither CUDA nor ROCm | §5 |
...
- Update `docs/rocm-passthrough-design.md` §7 with the resolved answers, and
  `docs/platform-comparison.md` with confirmed support status.
