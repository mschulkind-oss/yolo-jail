...
| [../design/provider-switching.md](../design/provider-switching.md) | Split out of bedrock-plumbing: a deselected profile leaves codex, pi and opencode asking a new endpoint for the old provider's model, and the fix is one new selection rule — clear the id yolo wrote, keep the one the user wrote. Its alias and shipped-id questions moved to model-lists-and-pickers 2026-09-25. | **DESIGN, nothing built** (re-verified 2026-09-24). Two live questions, gated by [`OQ-PS2`](../design/provider-switching.md#OQ-PS2); [`OQ-PS1`](../design/provider-switching.md#OQ-PS1) and [`OQ-PS3`](../design/provider-switching.md#OQ-PS3) keep pointer anchors to their new home. |
