...
| [../design/zai-plumbing.md](../design/zai-plumbing.md) | The first real consumer: both routes to "one provider, every agent" — name the protocol and fill the values ([§3](../design/zai-plumbing.md#3-route-a--name-the-protocol-fill-the-values-pure-config)), or ship a layered zai pack the user drops a key into ([§4](../design/zai-plumbing.md#4-route-b--the-zai-pack-enable-it-drop-in-a-key)) — and the endpoint-by-protocol resolution behind `-p zai` ([§5](../design/zai-plumbing.md#5-the-resolution-thing-b3)). | **DECIDED 2026-09-01** (ledger, [§8](../design/zai-plumbing.md#8-decision-ledger)); nothing built beyond the shipped `providers` key and the three derives it inherits. [§5](../design/zai-plumbing.md#5-the-resolution-thing-b3)'s resolution table now speaks the canonical vocabulary (`db6aff96`), and its follow-up note hands the codex dialect question to [providers.md §3](../reference/providers.md). |
