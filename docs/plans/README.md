...
|---|---|---|
| [roadmap.md](roadmap.md) | **THE forward plan.** Everything still to do and nothing else — grouped by state (💬 needs you / 📦 ready / 🔒 waiting / 🧊 icebox), counted from its own contents, and citing every open question by ID in the design doc that holds it. As of 2026-08-25 the 📦 queue holds **four** items — C2, C3, minimal disk footprint and program delivery §10 — three of them refilled by the four image-staging rulings of 2026-08-25. **Fourteen** 💬 rows stand between here and more. | **Start here for "what is left?"** |
