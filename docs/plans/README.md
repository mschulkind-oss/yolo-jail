...
| [../design/wire-bridge-gateway.md](../design/wire-bridge-gateway.md) | Split out of bedrock-plumbing 2026-09-25: the wire bridge as the jail's model gateway — SigV4 signing, routing claude's everything profile by model id, a sign-only chat-completions route, the subscription arm with opt-in failover, and the new all-traffic mode that enforces a model allowlist and routes per agent. | **DESIGN, 2026-09-25, nothing built.** Parts 1–4 ruled 2026-09-24 ([`OQ-BR10`](../design/wire-bridge-gateway.md#OQ-BR10), [`OQ-BR16`](../design/wire-bridge-gateway.md#OQ-BR16)–[`OQ-BR18`](../design/wire-bridge-gateway.md#OQ-BR18)); part 5 is the 2026-09-25 direction [DIR-WG1](../design/wire-bridge-gateway.md#DIR-WG1). Five live questions, gated by [`OQ-WG1`](../design/wire-bridge-gateway.md#OQ-WG1). |
...
| [../design/provider-switching.md](../design/provider-switching.md) | Split out of bedrock-plumbing: a deselected profile leaves codex, pi and opencode asking a new endpoint for the old provider's model, and the fix is one new selection rule — clear the id yolo wrote, keep the one the user wrote. Its alias and shipped-id questions moved to model-lists-and-pickers 2026-09-25. | **DESIGN, nothing built** (re-verified 2026-09-24). Two live questions, gated by [`OQ-PSW2`](../design/provider-switching.md#OQ-PSW2); [`OQ-PSW1`](../design/provider-switching.md#OQ-PSW1) and [`OQ-PSW3`](../design/provider-switching.md#OQ-PSW3) keep pointer anchors to their new home. |
| [../design/provider-credential-scope.md](../design/provider-credential-scope.md) | Split out of provider-switching on 2026-09-22: which provider **credentials** and profile-gated env reach an agent, and how a value reaches only the agent that selected it. Today every hydrated `env_sources` key and every satisfied pack `env` gate reach every agent. | **DESIGN, no gate built.** [`OQ-BR4`](../design/provider-credential-scope.md#OQ-BR4) moved in from bedrock-plumbing and was ruled 2026-09-25 (nothing leaks). Six live questions; [`OQ-CN6`](../design/provider-credential-scope.md#OQ-CN6) makes that ruling buildable, and [`OQ-CN1`](../design/provider-credential-scope.md#OQ-CN1) rules with [`OQ-BR8`](../design/providers-and-profiles-redesign.md#OQ-BR8) and agent-auth-modes [`OQ-9`](../design/agent-auth-modes.md#OQ-9). |
| [../design/gateway-provider-packs.md](../design/gateway-provider-packs.md) | Gateway providers (Kilo and its kind) shipped as provider packs rather than as agent-derive special cases. | **BUILT 2026-09-15**. MEASURED: the manifests and per-agent projections, by unit test. UNMEASURED: no live OpenRouter or Kilo run — no agent session through either gateway is recorded. One question, [`OQ-GP4`](../design/gateway-provider-packs.md#OQ-GP4) (the Kilo special-casing in two derives), holds its graduation. |
...
| [../design/sso-backed-bedrock.md](../design/sso-backed-bedrock.md) · [plan](../design/sso-backed-bedrock-plan.md) | Bedrock from a host `aws sso login`, served into the jail by `packs/aws-auth` over the container-credentials endpoint. [`OQ-SSO7`](../design/sso-backed-bedrock.md#13-decision-ledger) rules three Bedrock credentials supported, SSO primary. | **DECIDED, partly built** — plan steps 1–4 and 6 built and wired end to end in code; steps 5, 7, 8 unbuilt; nothing has run on a real host. Two questions filed 2026-09-25 are open: [`OQ-SSO8`](../design/sso-backed-bedrock.md#OQ-SSO8) (static keys beside the pointer) and [`OQ-SSO9`](../design/sso-backed-bedrock.md#OQ-SSO9) (option D's retirement). |
