...
| [../reference/zai-plumbing.md](../reference/zai-plumbing.md) | The first real consumer: both routes to "one provider, every agent" — name the protocol and fill the values ([§3](../reference/zai-plumbing.md#3-route-a--name-the-protocol-fill-the-values-pure-config)), or ship a layered zai pack the user drops a key into ([§4](../reference/zai-plumbing.md#4-route-b--the-zai-pack-enable-it-drop-in-a-key)) — and the endpoint-by-protocol resolution behind `-p zai` ([§5](../reference/zai-plumbing.md#5-the-resolution-thing-b3)). | **DECIDED 2026-09-01** (ledger, [§8](../reference/zai-plumbing.md#8-decision-ledger)); **and now BUILT** (corrected 2026-09-09): `packs/zai` ships the provider + profile, `internal/cli/run/providerpreflight.go` is in the tree, and pi/opencode selection landed in `6d1d7c54`. [§5](../reference/zai-plumbing.md#5-the-resolution-thing-b3)'s resolution table now speaks the canonical vocabulary (`db6aff96`), and its follow-up note hands the codex dialect question to [providers.md §3](../reference/providers.md). |
