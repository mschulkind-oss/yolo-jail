...
|---|---|---|
| [outstanding-work.md](outstanding-work.md) | Everything not built, split into QUEUED (decided 2026-08-04 rulings + the notch-divergence audit, to implement in ONE pass — the dependency column is load-bearing) and PARKED (E1–E5, no decision yet). Also links the noncontainer-nix study as future work. | **THE list.** Start here for "what is left?" |
