...
| 7 | **the QUEUED batch** — 9 decided items from the 2026-08-04 rulings + notch-divergence audit, to land in ONE pass ([outstanding-work.md](outstanding-work.md)) | jail-side | nothing blocks Q1–Q3, Q8; the rest chain off them. Q7 is forced by Phase 7 |
