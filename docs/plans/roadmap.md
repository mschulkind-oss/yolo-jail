...
**Status:** CURRENT — 2026-09-18. **41 rows**: 4 to rule first, 23 needing a decision,
5 ready to build, 7 waiting, 2 iced. Three 📦 rows CLOSED on 2026-09-18 and left the file
...
**122 live questions across 33 docs**, plus one 🔒 that command cannot see.
