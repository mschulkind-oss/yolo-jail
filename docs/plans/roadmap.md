...
**Status:** CURRENT — 2026-09-18. **43 rows**: 4 to rule first, 24 needing a decision,
6 ready to build, 7 waiting, 2 iced. Three 📦 rows CLOSED on 2026-09-18 and left the file
...
**125 live questions across 34 docs**, plus one 🔒 that command cannot see.
