...
existing ([OQ-5](reference/host-agent-environment.md#execution-flow)). `yolo check` tells you, every run, when the directory exists but is not on `PATH`.
...
📄 [`loopback-tls-reachability.md`](reference/loopback-tls-reachability.md) [OQ-R2](reference/loopback-tls-reachability.md#the-escalation-is-fatal), [OQ-R3](reference/loopback-tls-reachability.md#the-escalation-is-fatal).
...
📄 [`config-safety.md`](reference/config-safety.md) [OQ-D2](reference/config-safety.md#design-goals).
...
> writable by the thing being approved ([OQ-D1](reference/config-safety.md#design-goals)).
