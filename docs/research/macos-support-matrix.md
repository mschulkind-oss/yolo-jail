...
- [provisioner-sets.md](../design/provisioner-sets.md) — absorbed `noncontainer-nix-environment.md` on 2026-09-11. [§6.7](../design/provisioner-sets.md#67-macos-vs-linux-coverage-freshness-and-the-traps) is where the `x86_64-darwin` drop was first measured probe-by-probe and where its retraction lives; [§10](../design/provisioner-sets.md#10-alternatives-each-with-a-verdict) alternative H is the (now shipped) nix-profile work.
