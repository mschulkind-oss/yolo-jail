...
[OQ-5](#101-decision-ledger) by ID. The 2026-09-06 re-audit added two questions ([§10.2](#102-open-questions)) and one ruling, [OQ-8](#101-decision-ledger) — the go/no-go [OQ-1](#101-decision-ledger) held open, taken as a new ID precisely because [OQ-1](#101-decision-ledger)'s own text is cited from elsewhere.
