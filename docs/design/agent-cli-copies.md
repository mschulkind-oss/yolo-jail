...
> **Both fixed 2026-09-04** — see the appendix rows at the end of this doc for what each turned out
> to be. The second is a VESTIGE rather than a missing lock: the guard it is named for lived in a
