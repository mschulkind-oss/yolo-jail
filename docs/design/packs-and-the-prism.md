...
(verified 2026-09-02) — including the six that install no CLI at all: five that ship a loophole
(`audio` also contributes two env vars) and `zai`, which ships no CLI and no loophole — are pack
