...
`868b610f`, `ce5ad699`), the `--timing` split (`886a9191`) and the census (`67f87f36`), with
`7fa624ba` closing the D10/D11 delivery defects that verification filed. · Written against
`578c7e5f`, 2026-09-01.
