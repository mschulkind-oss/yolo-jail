...
│   ├── yolo-launchers/           → /home/agent/.yolo/bin/launch (lazy installers; SECOND on PATH since B2, 2026-09-04 — renamed from ~/.yolo-launchers 2026-08-30)
...
| Lazy-install launchers | `/home/agent/.yolo/bin/launch/` | Generated by entrypoint (SECOND on PATH since B2; the dir was `~/.yolo-launchers` until 2026-08-30) |
