...
**Reads with:** `docs/research/rocm-gpu-jail-findings.md` (the diagnosis) and
`docs/design/rocm-passthrough-design.md` §7.2 (the design rationale).
...
`docs/research/rocm-gpu-jail-findings.md`: the rocm-7.0 onnxruntime wheel lacks gfx1151
