...
proposed in [macos-nix-shell-backend-proposal.md](../plans/macos-nix-shell-backend-proposal.md).
...
## Pointers
- Proposal + settled decisions: [macos-nix-shell-backend-proposal.md](../plans/macos-nix-shell-backend-proposal.md)
- Why (the "no VM, not no emulation" reframing): [macos-no-vm-direction.md](../design/macos-no-vm-direction.md)
