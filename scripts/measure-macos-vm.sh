#!/usr/bin/env bash
# measure-macos-vm.sh — Option A measurement for docs/reference/macos-no-vm-direction.md
#
...
# Paste the final "RESULTS" block into docs/reference/macos-no-vm-direction.md.
...
# ===========================================================================
# RESULTS — paste this block into docs/reference/macos-no-vm-direction.md
# ===========================================================================
say "RESULTS (paste into docs/reference/macos-no-vm-direction.md → ## Option A measurements)"
say ""
