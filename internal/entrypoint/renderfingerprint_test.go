...
// header, which left this test green while internal/jailcontent caught it. Same for skills
...
// package's own tests are the gate there (jailcontent.TestBriefingJailHeaderIsUnchanged pins the
