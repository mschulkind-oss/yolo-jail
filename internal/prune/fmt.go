...
// fmtBytesUnits are the human-readable byte-count units.
var fmtBytesUnits = []string{"B", "KiB", "MiB", "GiB", "TiB"}

// FmtBytes renders a byte count human-readably: 1536 → "1.5 KiB",
// 1_500_000_000 → "1.4 GiB". Divide by 1024 until below 1024 (capped at TiB);
// at i==0 print the integer count, else one decimal place (%.1f,
// round-half-to-even).
