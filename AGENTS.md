...
- **Neovim Version**: The `"neovim"` key sets the neovim version installed via mise (default: `"stable"`). Accepts any mise-compatible version string: `"stable"`, `"nightly"`, `"0.11.6"`, etc. Does not trigger an image rebuild.
